                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Text(
                        'Upon agreeing to LifeCapture Media’s User Agreement, account members agree to upload only their own and personally shot video(s) to LifeCapture Media’s server for video transfer to user-specified disc format and to the shipping of said video only to a user-specified address.',
